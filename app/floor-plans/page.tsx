        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl md:text-5xl font-light text-gray-900 mb-4 tracking-wide">
              <span className="font-extralight">Explore All Henderson Properties</span>
            </h2>
            <p className="text-xl text-gray-600 font-light max-w-3xl mx-auto leading-relaxed">
              Beyond our exclusive floor plans, discover all available properties in Henderson, NV and surrounding areas 
              with expert guidance from Dr. Jan Duffy.
            </p>
          </div>
          <RealScoutWidget 
            title="Search All Available Properties"
